...
internal abstract class PluginViewBase : IPluginUIView, IPluginViewWithOptions
{
    ...
    /// <remarks>
    ///     <para>
    ///         Use this to specify what should happen when the user exits a view by navigating back,
    ...
    /// <remarks>
    ///     <para>
    ///         Use this to specify what should happen when the user exits a wizard view by navigating away,
    ///         mouse-clicking or tapping outside of the wizard.
    ///     </para>
    ///     <para>
    ///         Please note that it can make sense to use different values at different stages of
    ///         a wizard progress. For example, the initial wizard page should always be set to
    ///         <see cref="F:MediaBrowser.Model.Plugins.UI.Views.Enums.WizardHidingBehavior.AutoCancel" /> as there is not
    ///         state that
    ///         would need to be retained.
    ///     </para>
    ///     <para>
    ///         The default is <see cref="F:MediaBrowser.Model.Plugins.UI.Views.Enums.WizardHidingBehavior.AutoCancel" />
    ///     </para>
    ///     <para>Applies to</para>
    ///     <list type="bullet">
    ///         <item>Wizard Views (<see cref="T:MediaBrowser.Model.Plugins.UI.Views.IPluginWizardView" />)</item>
    ...
    /// <remarks>
    ///     <para>
    ///         Please note that in case of TV or mobile display modes, dialogs may always be shown
    ///         as full-screen.
    ///     </para>
