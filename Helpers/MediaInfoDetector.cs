...
internal static class MediaInfoDetector
{
    ...
    /// </summary>
    public static async Task DetectLanguagesFromMediaAsync(string mediaFile,
                                                           HashSet<string> audioLangs,
                                                           ...
                                                           bool enableLogging)
    {
        ...
        try
        {
            ...
            {
                if (!stream.TryGetProperty("codec_type", out var codecTypeElem)) continue;
                ...
                if (stream.TryGetProperty("tags", out var tags) && tags.TryGetProperty("language", out var langProp))
                {
                    ...
                    if (string.IsNullOrEmpty(langCodeRaw)) continue;
                    ...
                    else if (codecType == "subtitle") subtitleLangs.Add(langCodeNormalized);
                    /*if (enableLogging)
